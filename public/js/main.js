    ...
    return {
        ...
        checkPasswordStrength() {
            ...
            if (strongRegex.test(value)) {
                ...
                this.passwordStrengthText = "Pode melhorar...";
            } else {
...
$(document).ready(function () {
    // Change input from email to phone
    $("#button-change-phone").on("click", function () {
        $("#set-mail")
            .prop("name", "phone")
            .prop("id", "set-phone")
            .prop("type", "tel");
        ...
        $("#button-change-mail").css("display", "block");
    });
    // Change input from phone to email
    $("#button-change-mail").on("click", function () {
        $("#set-phone")
            .prop("name", "email")
            .prop("id", "set-mail")
            .prop("type", "email");
        $("#label").html("Email");
        $(this).css("display", "none");
        $("#button-change-phone").css("display", "block");
    });

    // Change class color of current page link - nav
    $(".active-nav a").each(function () {
        if (this.href == window.location.href) {
            $(this).closest("a").addClass("active");
        }
    });
    // Change class color of current page link - nav
    $(".active-mobile a").each(function () {
        if (this.href == window.location.href) {
            $(this).closest("a").addClass("text-blue-400");
        }
    });
    // $("#twitter-user")
    //     .val("@")
