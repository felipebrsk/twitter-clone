...
@section('content')
    <div class="notifications-header">
        ...
        <div class="notifications-options">
            <a href="#" class="option-active">Tudo</a>
            <a href="#" class="option-inactive">Menções</a>
        </div>
    </div>

    @foreach (Auth::user()->notifications as $notification)
        <a href="{{ $notification->data['actionURL'] }}">
            <div class="border-b border-l border-r border-dim-200 text-white @if ($loop->last) mb-48 @endif">
                <div class="flex md:items-center p-6">
                    ...
                    <div class="notification-max-w">
                        @if ($notification->data['fas'] == 'fa-heart')
                            <i class="fas {{ $notification->data['fas'] }} text-red-600"></i>
                        @else ()
                            <i class="fas {{ $notification->data['fas'] }} text-gray-400"></i>
                        @endif
