                        ...
                        <div class="pl-16">
                            ...
                            @if ($tweet->photo != null)
                                <div class="flex my-3 mr-2 rounded-2xl border border-gray-600">
                                    <img class="rounded-2xl object-center object-cover" src="{{ asset('img/tweets/large/' . $tweet->photo) }}"
                                        alt="{{ $tweet->photo }}" />
                                </div>
                            @endif
                    ...
                    <div class="relative m-2">
                        <div class="absolute text-gray-600 flex items-center pl-4 h-full cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" fill="currentColor" stroke-linecap="round"
    ...
    <script>
        $(document).ready(function(){
            $('.like').on('click', function(e){
                ...
                let like = e.target.previousElementSibing == null;
            });
        });
    </script>
@endpush